...
**Definition source:** `GHX-Generate-Product-Listing.json` (Desktop GH-X workflows export)  
...
On a schedule, search idea records, generate listing JSON via OpenAI HTTP, and update Airtable success/error fields.
